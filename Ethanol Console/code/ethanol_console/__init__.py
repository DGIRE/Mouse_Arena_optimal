"""Mouse Arena Ethanol Console -- trial-by-trial ethanol-threshold tool."""
__version__ = "0.1.0"
...
# This console runs in the same conda-forge ``ma-console`` env as the Data
# Console, so in practice this is a no-op there.
# ---------------------------------------------------------------------------
