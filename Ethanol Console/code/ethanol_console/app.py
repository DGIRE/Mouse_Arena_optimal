...
# -*- coding: utf-8 -*-
"""
app.py -- launch the Mouse Arena Ethanol Console.

Usage:
    python -m ethanol_console.app ["path\\to\\Mouse Arena Aggregate Data.h5"]

If no path is given, the default repo location is used
(../../DATA/Mouse Arena Aggregate Data.h5, resolved in console_config).
"""
...
def main(argv=None):
    ...
    if not os.path.isfile(agg_path):
        ...
        QtWidgets.QMessageBox.critical(
            None, "Mouse Arena Ethanol Console",
